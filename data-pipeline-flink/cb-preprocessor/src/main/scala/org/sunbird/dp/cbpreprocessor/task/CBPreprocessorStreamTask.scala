...
class CBPreprocessorStreamTask(config: PipelinePreprocessorConfig, kafkaConnector: FlinkKafkaConnector) {
...
object CBPreprocessorStreamTask {
  def main(args: Array[String]): Unit = {
    ...
    val task = new CBPreprocessorStreamTask(pipelinePreprocessorConfig, kafkaUtil)
    task.process()
  }
}
